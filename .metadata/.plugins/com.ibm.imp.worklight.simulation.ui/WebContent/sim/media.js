require(["dojo/dom"], function(dom){
	addService("Media", function(){
		...
		var setVolume = function(v) {
			if(audioTag.setVolume)
				audioTag.setVolume(v);
		};
...
//				audioUrl(Cordova.Media.onStatus, /* id */args[0], /* src */args[1]);
				...
				setVolume(args[1]);
/*
				var err = randMinMax(1, 4, 0);
				if(err) {
					var mess = "";
					switch(err) {
					case MediaError.MEDIA_ERR_ABORTED:
						mess = "MediaError.MEDIA_ERR_ABORTED";
						break;
					case MediaError.MEDIA_ERR_NETWORK:
						mess = "MediaError.MEDIA_ERR_NETWORK";
						break;
					case MediaError.MEDIA_ERR_DECODE:
						mess = "MediaError.MEDIA_ERR_DECODE";
						break;
					case MediaError.MEDIA_ERR_NONE_SUPPORTED:
						mess = "MediaError.MEDIA_ERR_NONE_SUPPORTED";
						break;
					}
					return new PluginResult(callbackId, PluginResultStatus.ERROR, new MediaError(err, mess), false);
				}
*/				
				return new PluginResult(callbackId, PluginResultStatus.OK, r, false);
			}
